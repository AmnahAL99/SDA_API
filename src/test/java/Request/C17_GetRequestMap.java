 ...
 */
    ...
    public void getRequestMap() {
        ...
        //Set the url
        spec.pathParams("1", "booking", "2", "457");

        //Set the expected data
        //We set the expected data to use it in assertion
        Map<String, Object> bookingDates = RestulTestData.bookingDatesMapper("2018-01-01", "2019-01-01");
        Map<String, Object> expectedData =  RestulTestData.bookingMapper("John", "Smith", 111, true, bookingDates, "Breakfast");
